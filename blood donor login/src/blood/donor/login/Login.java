...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
        conn = DBConnector.DBConnector.ConnectDb();
    ...
    private void initComponents() {
        ...
        txt_username.setBackground(new java.awt.Color(255, 230, 230));
        txt_username.setBorder(null);
        txt_username.setMargin(new java.awt.Insets(0, 0, 0, 0));
        txt_username.setMinimumSize(new java.awt.Dimension(0, 0));
        ...
        getContentPane().add(txt_username, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 306, 140, 20));

        txt_password.setBackground(new java.awt.Color(255, 230, 230));
        txt_password.setBorder(null);
        getContentPane().add(txt_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 346, 140, 20));
...
//        if (user_name.getText().equals("oras") && password.getText().equals("1234")) {
//            setVisible(false);
